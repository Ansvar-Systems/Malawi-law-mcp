...
**Endpoint:** `https://mcp.ansvar.eu/law-mw/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add malawi-law --transport http https://mcp.ansvar.eu/law-mw/mcp` |
...
```json
{
  "mcpServers": {
    "malawi-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-mw/mcp"
    }
  }
}
```
