#!/usr/bin/env tsx
/**
 * Malawi Law MCP -- Census Script (AfricanLII Direct Scraping)
 *
 * Scrapes the legislation listing pages from malawilii.org to enumerate
 * ALL acts. Writes data/census.json in golden standard format.
 *
 * No API key required -- scrapes the public listing pages directly.
 *
 * Source: https://malawilii.org/legislation/
 *
 * Usage:
...
const JURISDICTION = 'MW';
const JURISDICTION_NAME = 'Malawi';
const PORTAL = 'https://malawilii.org';
const LISTING_BASE = 'https://malawilii.org/legislation/';
const AKN_PATH_PREFIX = '/akn/mw/';
 ...
 * Extracts <a href="/akn/mw/act/..."> links and their text.
 */
