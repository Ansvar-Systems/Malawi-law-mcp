/**
 * Akoma Ntoso HTML parser for MalawiLII legislation
 *
 * Parses structured AKN HTML served by the Peachjam platform (malawilii.org).
 ...
 *
 * This parser works with any Laws.Africa / Peachjam country
...
/**
 * Parse Peachjam/Laws.Africa Akoma Ntoso HTML to extract provisions.
 *
 ...
 */
export function parseMalawiLawHtml(html: string, act: ActIndexEntry): ParsedAct {
